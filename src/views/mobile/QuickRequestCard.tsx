...
export default function QuickRequestCard({ title, iconName }: QuickRequestCardProps) {
  return (
    <div className="bg-[#1C1C1E] p-4 rounded-[28px] flex items-center justify-between min-h-[72px] w-full border border-transparent active:scale-[0.98] transition-transform">
